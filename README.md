...
3) import in Zabbix Data Collection - Templates the file zbx_import_templates_v03.json (<SRC = "https://github.com/fernandozangari/zabbix_for_mainframe/blob/main/SRC/zbx_import_templates_v03.json">)
